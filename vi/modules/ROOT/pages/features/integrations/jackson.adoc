...
[NOTE]
====
Hỗ trợ Jackson 2 vẫn khả dụng nhưng đã deprecated để loại bỏ, vì vậy bạn được khuyến khích di chuyển sang Jackson 3.
====
...
Nếu cần, bạn có thể thêm các class tùy chỉnh vào quá trình xử lý xác thực.
